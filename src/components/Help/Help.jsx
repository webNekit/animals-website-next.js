        ...
        <div className="w-full flex flex-col gap-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
            {[1, 2, 3, 4, 5, 6].map((item) => {
              return (
                <div className="w-full rounded-lg bg-blue-50 p-5 flex flex-col gap-4 help-card">
                  ...
                  <Link href={'/'} className='flex items-center gap-2 text-lg text-zinc-800 font-medium hover:text-zinc-600 transition-colors'>Подробнее <FaChevronRight className='text-sm' /></Link>
                </div>
              )
            })}
          </div>
