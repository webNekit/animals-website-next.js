        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
            <div className="w-full bg-white border p-3 rounded-lg">
                <div className="w-full h-[320px] overflow-hidden rounded-lg group relative">
                    <span className="absolute top-2 left-2 px-2 py-1 bg-pink-400 rounded-full z-30 text-sm text-white cursor-default">Ищет дом</span>
                ...
                <Link href={'/pets/' + 1} className='inline-block text-lg text-zinc-800 font-medium border-b-2 mt-5 border-orange-300 hover:text-zinc-600 transition-colors'>Подробнее</Link>
            </div>
        </div>
    )
}
